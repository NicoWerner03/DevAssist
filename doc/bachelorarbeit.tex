...
Software-Tickets bilden in Entwicklungsteams die Schnittstelle zwischen fachlichem Bedarf, Umsetzung und Prüfung. Relevante Angaben sind häufig unvollständig oder über Beschreibung und Kommentare verteilt. Diese Arbeit untersucht, welche Informationen ein GitLab-Ticket für eine nachvollziehbare Umsetzung und Prüfung benötigt und wie ein KI-gestützter Assistent kontrolliert in einen GitLab-Workflow integriert werden kann. Ziel, Kontext, erwartetes Verhalten, Prüfkriterien und sichtbare Unsicherheit bilden den fachlichen Kern.

Dazu wird Dev-Assist als Proof of Concept in TypeScript mit Express umgesetzt. GitLab-Webhooks lösen die Verarbeitung aus. Der Dienst sammelt Issue- und Kommentardaten sowie optionalen Repository-Kontext, übergibt sie an einen OpenCode-Analyseagenten und prüft die Antwort gegen ein festes Ausgabeschema. Je nach Informationslage entstehen Rückfragen oder ein strukturierter Vorschlag. Das Issue wird erst nach einem gesonderten Publish-Kommando geändert. Ausgabeschema, Schutz vor Bot-Schleifen und lokale Persistenz begrenzen die Autonomie des Modells.
